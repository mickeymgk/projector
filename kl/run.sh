...
# ---------------------------------------------------------------------
IDE_BIN_HOME=/workspaces/tgx-builder/android-studio/bin
...
exec "$JAVA_BIN" \
 -classpath "$CLASS_PATH:/home/codespace/.local/lib/python3.10/site-packages/projector_installer/bundled/server/*" \
  "-XX:ErrorFile=$HOME/java_error_in_studio_%p.log" \
  "-XX:HeapDumpPath=$HOME/java_error_in_studio_.hprof" \
  ${VM_OPTIONS} \
  "-Djb.vmOptionsFile=${USER_VM_OPTIONS_FILE:-${VM_OPTIONS_FILE}}" \
 -Didea.properties.file=/home/codespace/.projector/configs/kl/idea.properties \
 ...
 -DORG_JETBRAINS_PROJECTOR_SERVER_PORT=8891 \
 -Dorg.jetbrains.projector.server.classToLaunch=com.intellij.idea.Main \
 -DORG_JETBRAINS_PROJECTOR_SERVER_HOST=localhost \
